...
ActiveRecord::Schema.define(version: 20160420055332) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.integer  "automatic_confirmation_after_days", limit: 4
    t.integer  "community_id",                      limit: 4
  end
  ...
  add_index "custom_field_option_selections", ["custom_field_value_id"], name: "index_custom_field_option_selections_on_custom_field_value_id", using: :btree
  ...
  add_index "listings", ["category_old"], name: "index_listings_on_category_old", using: :btree
  ...
  add_index "listings", ["listing_type_old"], name: "index_listings_on_listing_type_old", using: :btree
  add_index "listings", ["old_category_id"], name: "index_listings_on_old_category_id", using: :btree
  add_index "listings", ["open"], name: "index_listings_on_open", using: :btree
  add_index "listings", ["share_type_id"], name: "index_listings_on_share_type_id", using: :btree
  add_index "listings", ["share_type_old"], name: "index_listings_on_share_type_old", using: :btree
...
>>>>>>> 509a43a298fd814f4637f7f73082d3366e066c6f
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.string   "mangopay_id",                        limit: 255
    t.string   "bank_account_owner_name",            limit: 255
    t.string   "bank_account_owner_address",         limit: 255
    t.string   "iban",                               limit: 255
    t.string   "bic",                                limit: 255
    t.string   "mangopay_beneficiary_id",            limit: 255
    t.boolean  "is_organization"
    t.string   "company_id",                         limit: 255
    t.string   "checkout_merchant_key",              limit: 255
  ...
  add_index "transaction_transitions", ["sort_key", "transaction_id"], name: "index_transaction_transitions_on_sort_key_and_transaction_id", unique: true, using: :btree
  add_index "transaction_transitions", ["transaction_id"], name: "index_transaction_transitions_on_transaction_id", using: :btree
